...
```luau
loadstring(game:HttpGet("https://raw.githubusercontent.com/amrho94/Vape/main/NewMainScript.lua", true))()
```
...
1. Deleting the vape folder (WITH THE GAME CLOSED).
2. Making sure you have connection to [the main loadstring.](https://raw.githubusercontent.com/amrho94/Vape/refs/heads/main/NewMainScript.lua)
